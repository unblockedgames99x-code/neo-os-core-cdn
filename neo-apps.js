(function () {
  ...
  window.NEO_EXTRA_APPS = Object.assign({}, window.NEO_EXTRA_APPS || {}, {
    ...
    games: {
      ...
      icon: "steam",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@d165d99176f2f91f26a455ed69cfc491fdd29a17/neo-games/index.html?build=20260919-steam-client-v2",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    movies: {
      ...
      icon: "movies",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@d165d99176f2f91f26a455ed69cfc491fdd29a17/neo-tv/index.html?build=20260912-media-fallback-v9",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
