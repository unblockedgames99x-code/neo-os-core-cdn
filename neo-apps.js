(function () {
  ...
  window.NEO_EXTRA_APPS = Object.assign({}, window.NEO_EXTRA_APPS || {}, {
    ...
    games: {
      ...
      icon: "xbox-games",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@020fb07fc534ae98915fb3a953744a061539df5c/neo-games/index.html?build=20260912-master-list-v1",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    movies: {
      ...
      icon: "movies",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@020fb07fc534ae98915fb3a953744a061539df5c/neo-tv/index.html?build=20260912-vidfast-v1",
      keepAlive: true,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    "geometry-dash": {
      ...
      icon: "geometry-dash",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-core-cdn@1cab9188fbe597b4bf6ab3e62ae65b94564a815a/games/web-dashers.html",
      width: 1180,
      height: 760,
      launcher: true,
      pinned: true,
    ...
    "neo-cloud": {
      ...
      icon: "neo-cloud",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@020fb07fc534ae98915fb3a953744a061539df5c/neo-cloud/index.html?v=20260907-online-runtime-v1",
      width: 1180,
      height: 760,
      launcher: true,
      pinned: false,
