(function () {
  ...
  window.NEO_EXTRA_APPS = Object.assign({}, window.NEO_EXTRA_APPS || {}, {
    stream: {
      ...
      browserTarget: window.NEO_LOCAL_CONFIG ? window.NEO_LOCAL_CONFIG.music : "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-music-two-cdn@d8c85b7f5d1da9eba9d641c26dd3e26975fc764f/music-v2/launch.svg",
      browserDirect: true,
      browserChrome: false,
    ...
    games: {
      ...
      icon: "steam",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@3c4437c6093eaf4d5c608fbca2ded7e5f4a14984/neo-games/index.html?build=20260919-steam-client-v2",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    movies: {
      ...
      icon: "movies",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@3c4437c6093eaf4d5c608fbca2ded7e5f4a14984/neo-tv/index.html?build=20260912-media-fallback-v9",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
