(function () {
  ...
  window.NEO_EXTRA_APPS = Object.assign({}, window.NEO_EXTRA_APPS || {}, {
    stream: {
      ...
      browserTarget: window.NEO_LOCAL_CONFIG ? window.NEO_LOCAL_CONFIG.music : "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-music-two-cdn@fd29f608f257eba1235d2afa21cee3323766b746/music-v2/launch.svg",
      browserDirect: true,
      browserChrome: false,
    ...
    cinehd: {
      ...
      icon: "zstream",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@77f0fd327a7ae7cfd7e6ec1b42013f365813d1a4/neo-tv/launch.svg?v=20260909-real-url-v1",
      keepAlive: true,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    discord: {
      ...
      icon: "discord",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@d18d995be07032ced7eb1c82005bd9157995cdc9/NEO-BROWSER/index.html?neo-app-mode=1&neo-app-target=https%3A%2F%2Fdiscord.com%2Fapp",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    "youtube-app": {
      ...
      icon: "youtube",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@d18d995be07032ced7eb1c82005bd9157995cdc9/NEO-BROWSER/index.html?neo-app-mode=1&neo-app-target=https%3A%2F%2Fwww.youtube.com%2F&neo-youtube-mode=1",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    "neo-cloud": {
      ...
      icon: "neo-cloud",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@77f0fd327a7ae7cfd7e6ec1b42013f365813d1a4/neo-cloud/index.html?v=20260907-online-runtime-v1",
      width: 1180,
      height: 760,
      launcher: true,
      pinned: false,
