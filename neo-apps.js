(function () {
  ...
  window.NEO_EXTRA_APPS = Object.assign({}, window.NEO_EXTRA_APPS || {}, {
    stream: {
      ...
      browserTarget: window.NEO_LOCAL_CONFIG ? window.NEO_LOCAL_CONFIG.music : "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-music-two-cdn@35659bc4a5a6be0cf898dc5897bbbf46921d57f0/music-v2/launch.svg",
      browserDirect: true,
      browserChrome: false,
    ...
    games: {
      ...
      icon: "steam",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@0811541b8449b2425235c40168a004d81ca1d6cb/neo-games/index.html?build=20260919-steam-client-v2",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    movies: {
      ...
      icon: "movies",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@0811541b8449b2425235c40168a004d81ca1d6cb/neo-tv/index.html?build=20260912-media-fallback-v9",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
