(function () {
  ...
  window.NEO_EXTRA_APPS = Object.assign({}, window.NEO_EXTRA_APPS || {}, {
    stream: {
      ...
      browserTarget: window.NEO_LOCAL_CONFIG ? window.NEO_LOCAL_CONFIG.music : "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-music-two-cdn@ccf9d99b55a3ce8c174472a8c359d40e05bd840a/music-v2/launch.svg",
      browserDirect: true,
      browserChrome: false,
    ...
    discord: {
      ...
      icon: "discord",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@82130d3c8f8df30645cf694271e7698c076ef353/NEO-BROWSER/index.html?neo-app-mode=1&neo-app-target=https%3A%2F%2Fdiscord.com%2Fapp",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    games: {
      ...
      icon: "xbox-games",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@ce27052ae4865b799544f0960b83dbed16c99b50/neo-games/index.html?build=20260912-game-player-v2",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    movies: {
      ...
      icon: "movies",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@ce27052ae4865b799544f0960b83dbed16c99b50/neo-tv/index.html?build=20260912-media-fallback-v9",
      keepAlive: true,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    "geometry-dash": {
      ...
      icon: "geometry-dash",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-core-cdn@624406ad4b2f11a2db8d328f6a8dcf468d366f99/games/web-dashers.html",
      width: 1180,
      height: 760,
      launcher: true,
      pinned: true,
    ...
    "neo-cloud": {
      ...
      icon: "neo-cloud",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@ce27052ae4865b799544f0960b83dbed16c99b50/neo-cloud/index.html?v=20260907-online-runtime-v1",
      width: 1180,
      height: 760,
      launcher: true,
      pinned: false,
    ...
    nowgg: {
      ...
      icon: "gamepad",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@82130d3c8f8df30645cf694271e7698c076ef353/NEO-BROWSER/index.html?neo-app-mode=1&neo-custom-app=1&neo-app-target=https%3A%2F%2Fnowgg.fun%2F",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    "neo-ai": {
      ...
      icon: "chatgpt",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@82130d3c8f8df30645cf694271e7698c076ef353/neo-ai/index.html?build=20260912-default-20b-v1",
      keepAlive: true,
      width: 1120,
      height: 760,
      launcher: true,
