(function () {
  ...
  window.NEO_EXTRA_APPS = Object.assign({}, window.NEO_EXTRA_APPS || {}, {
    stream: {
      ...
      browserTarget: window.NEO_LOCAL_CONFIG ? window.NEO_LOCAL_CONFIG.music : "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-music-two-cdn@494dd1d8dd85684b9dc1b90baff458aba6ba8ce8/music-v2/launch.svg",
      browserDirect: true,
      browserChrome: false,
    ...
    games: {
      ...
      icon: "steam",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@691b63a6d463af611a199a5ae99bfa0a3f67c458/neo-games/index.html?build=20260921-fern-only-v1",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
