(function () {
  ...
  window.NEO_EXTRA_APPS = Object.assign({}, window.NEO_EXTRA_APPS || {}, {
    stream: {
      ...
      browserTarget: window.NEO_LOCAL_CONFIG ? window.NEO_LOCAL_CONFIG.music : "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-music-two-cdn@7656d317298fbe778dc8e890ce5410b34fc51380/music-v2/launch.svg",
      browserDirect: true,
      browserChrome: false,
    ...
    discord: {
      ...
      icon: "discord",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@437786b914b69e39e4eb8d81de0def220bf3214e/NEO-BROWSER/index.html?neo-app-mode=1&neo-app-target=https%3A%2F%2Fdiscord.com%2Fapp",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    games: {
      ...
      icon: "xbox-games",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@6584ed362888365abb87202b37c87b97f588594b/neo-games/index.html?build=20260912-game-player-v2",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    movies: {
      ...
      icon: "movies",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@6584ed362888365abb87202b37c87b97f588594b/neo-tv/index.html?build=20260912-media-fallback-v9",
      keepAlive: true,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    "geometry-dash": {
      ...
      icon: "geometry-dash",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-core-cdn@42765f56bf693f2b91089bfc60152895da444ab3/games/web-dashers.html",
      width: 1180,
      height: 760,
      launcher: true,
      pinned: true,
    ...
    "neo-cloud": {
      ...
      icon: "neo-cloud",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@6584ed362888365abb87202b37c87b97f588594b/neo-cloud/index.html?v=20260907-online-runtime-v1",
      width: 1180,
      height: 760,
      launcher: true,
      pinned: false,
    ...
    nowgg: {
      ...
      icon: "gamepad",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@437786b914b69e39e4eb8d81de0def220bf3214e/NEO-BROWSER/index.html?neo-app-mode=1&neo-custom-app=1&neo-app-target=https%3A%2F%2Fnowgg.fun%2F",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    "neo-ai": {
      ...
      icon: "chatgpt",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@437786b914b69e39e4eb8d81de0def220bf3214e/neo-ai/index.html?build=20260912-default-20b-v1",
      keepAlive: true,
      width: 1120,
      height: 760,
      launcher: true,
