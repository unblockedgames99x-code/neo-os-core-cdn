(function () {
  ...
  window.NEO_EXTRA_APPS = Object.assign({}, window.NEO_EXTRA_APPS || {}, {
    stream: {
      ...
      browserTarget: window.NEO_LOCAL_CONFIG ? window.NEO_LOCAL_CONFIG.music : "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-music-two-cdn@3d3b54c9988f7ccb084896508fd6a8a49ddb54cc/music-v2/launch.svg",
      browserDirect: true,
      browserChrome: false,
    ...
    discord: {
      ...
      icon: "discord",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@038eb48130a8fbea13ebb7a2c91a7c1d6b9a820d/NEO-BROWSER/index.html?neo-app-mode=1&neo-app-target=https%3A%2F%2Fdiscord.com%2Fapp",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    games: {
      ...
      icon: "xbox-games",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@5126192a5d615b4ba3542f7751b83120c77da91b/neo-games/index.html?build=20260912-master-list-v1",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    movies: {
      ...
      icon: "movies",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@5126192a5d615b4ba3542f7751b83120c77da91b/neo-tv/index.html?build=20260912-vidfast-v1",
      keepAlive: true,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    "geometry-dash": {
      ...
      icon: "geometry-dash",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-core-cdn@110f99d58514d3263ff46f8724566b020c19f39d/games/web-dashers.html",
      width: 1180,
      height: 760,
      launcher: true,
      pinned: true,
    ...
    "neo-cloud": {
      ...
      icon: "neo-cloud",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@5126192a5d615b4ba3542f7751b83120c77da91b/neo-cloud/index.html?v=20260907-online-runtime-v1",
      width: 1180,
      height: 760,
      launcher: true,
      pinned: false,
    ...
    nowgg: {
      ...
      icon: "gamepad",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@038eb48130a8fbea13ebb7a2c91a7c1d6b9a820d/NEO-BROWSER/index.html?neo-app-mode=1&neo-custom-app=1&neo-app-target=https%3A%2F%2Fnowgg.fun%2F",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    "neo-ai": {
      ...
      icon: "chatgpt",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@038eb48130a8fbea13ebb7a2c91a7c1d6b9a820d/neo-ai/index.html?build=20260912-serum-models-v1",
      keepAlive: true,
      width: 1120,
      height: 760,
      launcher: true,
