(function () {
  ...
  window.NEO_EXTRA_APPS = Object.assign({}, window.NEO_EXTRA_APPS || {}, {
    stream: {
      ...
      browserTarget: window.NEO_LOCAL_CONFIG ? window.NEO_LOCAL_CONFIG.music : "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-music-two-cdn@885927eb5543f0d8a12fac50deda3b79f0c89c92/music-v2/launch.svg",
      browserDirect: true,
      browserChrome: false,
    ...
    discord: {
      ...
      icon: "discord",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@8fc487d0f13e7b1251804fcaa86dcfdf53f1dcdf/NEO-BROWSER/index.html?neo-app-mode=1&neo-app-target=https%3A%2F%2Fdiscord.com%2Fapp",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    games: {
      ...
      icon: "xbox-games",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@56f1cf1935c529474340cb4def51f582cbb345dd/neo-games/index.html?build=20260912-master-list-v1",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    movies: {
      ...
      icon: "movies",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@56f1cf1935c529474340cb4def51f582cbb345dd/neo-tv/index.html?build=20260912-vidfast-v1",
      keepAlive: true,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    "geometry-dash": {
      ...
      icon: "geometry-dash",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-core-cdn@20bac5d5d709d47a83ac33e8cf360dda4587cda7/games/web-dashers.html",
      width: 1180,
      height: 760,
      launcher: true,
      pinned: true,
    ...
    "neo-cloud": {
      ...
      icon: "neo-cloud",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@56f1cf1935c529474340cb4def51f582cbb345dd/neo-cloud/index.html?v=20260907-online-runtime-v1",
      width: 1180,
      height: 760,
      launcher: true,
      pinned: false,
    ...
    nowgg: {
      ...
      icon: "gamepad",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@8fc487d0f13e7b1251804fcaa86dcfdf53f1dcdf/NEO-BROWSER/index.html?neo-app-mode=1&neo-custom-app=1&neo-app-target=https%3A%2F%2Fnowgg.fun%2F",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    "neo-ai": {
      ...
      icon: "chatgpt",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@8fc487d0f13e7b1251804fcaa86dcfdf53f1dcdf/neo-ai/index.html?build=20260912-serum-models-v1",
      keepAlive: true,
      width: 1120,
      height: 760,
      launcher: true,
