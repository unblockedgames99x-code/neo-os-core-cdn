(function () {
  ...
  window.NEO_EXTRA_APPS = Object.assign({}, window.NEO_EXTRA_APPS || {}, {
    stream: {
      ...
      browserTarget: window.NEO_LOCAL_CONFIG ? window.NEO_LOCAL_CONFIG.music : "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-music-two-cdn@f9f545471d36933c33f019df771f4ca28dc14fb4/music-v2/launch.svg",
      browserDirect: true,
      browserChrome: false,
    ...
    games: {
      ...
      icon: "steam",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@aa002ed2366231f664841bbc16389bf513087a05/neo-games/index.html?build=20260919-steam-client-v2",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    movies: {
      ...
      icon: "movies",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@aa002ed2366231f664841bbc16389bf513087a05/neo-tv/index.html?build=20260912-media-fallback-v9",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
