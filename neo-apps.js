(function () {
  ...
  window.NEO_EXTRA_APPS = Object.assign({}, window.NEO_EXTRA_APPS || {}, {
    stream: {
      ...
      browserTarget: window.NEO_LOCAL_CONFIG ? window.NEO_LOCAL_CONFIG.music : "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-music-two-cdn@main/music-v2/index.html",
      browserDirect: true,
      browserChrome: false,
    ...
    cinehd: {
      ...
      icon: "zstream",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@main/neo-tv/index.html?v=20260908-movie-loader-v1",
      keepAlive: true,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    discord: {
      ...
      icon: "discord",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@main/NEO-BROWSER/index.html?neo-app-mode=1&neo-app-target=https%3A%2F%2Fdiscord.com%2Fapp",
      keepAlive: true,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    "youtube-app": {
      ...
      icon: "youtube",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@main/NEO-BROWSER/index.html?neo-app-mode=1&neo-app-target=https%3A%2F%2Fwww.youtube.com%2F",
      keepAlive: true,
      width: 1180,
      height: 760,
      launcher: true,
