(function () {
  ...
  window.NEO_EXTRA_APPS = Object.assign({}, window.NEO_EXTRA_APPS || {}, {
    stream: {
      ...
      browserTarget: window.NEO_LOCAL_CONFIG ? window.NEO_LOCAL_CONFIG.music : "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-music-two-cdn@d52e530e4eb3170fc0c9e3a0caaca678603d8930/music-v2/launch.svg",
      browserDirect: true,
      browserChrome: false,
    ...
    games: {
      ...
      icon: "steam",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@ba2a7c72f067ef9c69f119efa39fac3368210996/neo-games/index.html?build=20260921-fern-only-v1",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
