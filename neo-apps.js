(function () {
  ...
  window.NEO_EXTRA_APPS = Object.assign({}, window.NEO_EXTRA_APPS || {}, {
    ...
    cinehd: {
      ...
      icon: "zstream",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@726ba0acb7a9340d6249b2bd74cb619253720f7e/neo-tv/launch.svg?v=20260910-verified-catalog-v1",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    anime: {
      ...
      icon: "zstream",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@726ba0acb7a9340d6249b2bd74cb619253720f7e/neo-tv/launch.svg?view=anime&v=20260910-verified-catalog-v1",
      keepAlive: false,
      width: 1180,
      height: 760,
      launcher: true,
    ...
    manga: {
      ...
      icon: "file",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@726ba0acb7a9340d6249b2bd74cb619253720f7e/neo-tv/launch.svg?view=manga&v=20260910-verified-catalog-v1",
      keepAlive: false,
      width: 1080,
      height: 760,
      launcher: true,
