(function () {
  ...
  window.NEO_LOCAL_CONFIG = Object.freeze({
    ...
    assetBase: base.href,
    music: isCdnRunner ? "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-music-two-cdn@88a8bacca3ac1711fc5cea6fdda23778326ced50/music-v2/launch.svg?v=20260918-proxy-only-v1" : new URL("music-v2/index.html?v=20260918-proxy-only-v1&theme=system-v1&widgets=live-v1", base).href,
    browser: isCdnRunner ? "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@4a98de12039715fe795e08b51290d95c5eb7f356/nextnode-browser/launch.svg?v=20260919-search-aether-v1" : new URL("nextnode-browser/index.html?v=20260919-search-aether-v1", base).href,
    ...
    ].map(function (asset) { return isCdnRunner ? new URL("nextnode-browser/" + asset, "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@4a98de12039715fe795e08b51290d95c5eb7f356/").href : new URL("nextnode-browser/" + asset, base).href; })),
    ...
    appProxy: isCdnRunner ? "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@4a98de12039715fe795e08b51290d95c5eb7f356/NEO-BROWSER/index.html?v=20260913-yukios-wisp-v1" : new URL("NEO-BROWSER/index.html?v=20260913-yukios-wisp-v1", base).href,
    ...
    support: isCdnRunner ? "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@4a98de12039715fe795e08b51290d95c5eb7f356/local-browser/support.html" : new URL("local-browser/support.html", base).href,
    unavailable: isCdnRunner ? "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@4a98de12039715fe795e08b51290d95c5eb7f356/local-browser/unavailable.html" : new URL("local-browser/unavailable.html", base).href,
