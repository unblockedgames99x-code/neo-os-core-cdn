(function () {
  ...
  window.NEO_LOCAL_CONFIG = Object.freeze({
    ...
    assetBase: base.href,
    music: isCdnRunner ? "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-music-two-cdn@25e5750f27b6eb09224115240f9bdac5af13975a/music-v2/launch.svg?v=20260918-proxy-only-v1" : new URL("music-v2/index.html?v=20260918-proxy-only-v1&theme=system-v1&widgets=live-v1", base).href,
    browser: isCdnRunner ? "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@87f3e9fb8b676001154ddddeb187ed684a064b94/nextnode-browser/launch.svg?v=20260914-official-wisp-v2" : new URL("nextnode-browser/index.html?v=20260914-official-wisp-v2", base).href,
    ...
    ].map(function (asset) { return isCdnRunner ? new URL("nextnode-browser/" + asset, "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@87f3e9fb8b676001154ddddeb187ed684a064b94/").href : new URL("nextnode-browser/" + asset, base).href; })),
    ...
    appProxy: isCdnRunner ? "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@87f3e9fb8b676001154ddddeb187ed684a064b94/NEO-BROWSER/index.html?v=20260913-yukios-wisp-v1" : new URL("NEO-BROWSER/index.html?v=20260913-yukios-wisp-v1", base).href,
    ...
    support: isCdnRunner ? "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@87f3e9fb8b676001154ddddeb187ed684a064b94/local-browser/support.html" : new URL("local-browser/support.html", base).href,
    unavailable: isCdnRunner ? "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@87f3e9fb8b676001154ddddeb187ed684a064b94/local-browser/unavailable.html" : new URL("local-browser/unavailable.html", base).href,
