(function () {
  ...
  window.NEO_LOCAL_CONFIG = Object.freeze({
    ...
    browser: isCdnRunner ? "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@8341e1545f12abd812887d0d02f04e9706707b09/nextnode-browser/launch.svg?v=20260914-official-wisp-v2" : new URL("nextnode-browser/index.html?v=20260914-official-wisp-v2", base).href,
    ...
    ].map(function (asset) { return isCdnRunner ? new URL("nextnode-browser/" + asset, "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@8341e1545f12abd812887d0d02f04e9706707b09/").href : new URL("nextnode-browser/" + asset, base).href; })),
    ...
    appProxy: isCdnRunner ? "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@8341e1545f12abd812887d0d02f04e9706707b09/NEO-BROWSER/index.html?v=20260913-yukios-wisp-v1" : new URL("NEO-BROWSER/index.html?v=20260913-yukios-wisp-v1", base).href,
    ...
    support: isCdnRunner ? "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@8341e1545f12abd812887d0d02f04e9706707b09/local-browser/support.html" : new URL("local-browser/support.html", base).href,
    unavailable: isCdnRunner ? "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@8341e1545f12abd812887d0d02f04e9706707b09/local-browser/unavailable.html" : new URL("local-browser/unavailable.html", base).href,
