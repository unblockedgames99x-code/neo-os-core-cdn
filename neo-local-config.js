(function () {
  ...
  window.NEO_LOCAL_CONFIG = Object.freeze({
    ...
    assetBase: base.href,
    music: isCdnRunner ? "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-music-two-cdn@6eda44eb77343a6f0a003fae310334ce8e04e3ba/music-v2/launch.svg?v=20260919-scholarnook-v1" : new URL("music-v2/index.html?v=20260919-scholarnook-v1&theme=system-v1&widgets=live-v1", base).href,
    browser: isCdnRunner ? "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@7af9281728e2505c2487d92c5678001fed5334ca/nextnode-browser/launch.svg?v=20260919-auto-wisp-v1" : new URL("nextnode-browser/index.html?v=20260919-auto-wisp-v1", base).href,
    ...
    ].map(function (asset) { return isCdnRunner ? new URL("nextnode-browser/" + asset, "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@7af9281728e2505c2487d92c5678001fed5334ca/").href : new URL("nextnode-browser/" + asset, base).href; })),
    ...
    appProxy: isCdnRunner ? "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@7af9281728e2505c2487d92c5678001fed5334ca/NEO-BROWSER/index.html?v=20260913-yukios-wisp-v1" : new URL("NEO-BROWSER/index.html?v=20260913-yukios-wisp-v1", base).href,
    ...
    support: isCdnRunner ? "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@7af9281728e2505c2487d92c5678001fed5334ca/local-browser/support.html" : new URL("local-browser/support.html", base).href,
    unavailable: isCdnRunner ? "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@7af9281728e2505c2487d92c5678001fed5334ca/local-browser/unavailable.html" : new URL("local-browser/unavailable.html", base).href,
