(function () {
  ...
  var apps = {
    browser: {
      ...
      icon: "duckduckgo",
    route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@4164452b6b784ee0728ccfb70abd785b4d6cd890/NEO-BROWSER/index.html?v=20260912-proxy-ready-v2",
      keepAlive: true,
      width: 1080,
      height: 720,
      launcher: true,
    ...
    chat: {
      ...
      icon: "chat",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@c3d3239fa93251247903c990fe44220557365877/neo-chat/index.html?v=20260910-sharp-photos-v1",
      width: 1180,
      height: 760,
      launcher: true,
      pinned: true,
