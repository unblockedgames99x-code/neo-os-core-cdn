(function () {
  ...
  var apps = {
    browser: {
      ...
      icon: "duckduckgo",
    route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@87663363da0fe125c5741f716f58bfbce7d4723a/NEO-BROWSER/index.html?v=20260912-proxy-ready-v2",
      keepAlive: true,
      width: 1080,
      height: 720,
      launcher: true,
    ...
    chat: {
      ...
      icon: "chat",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@c6556c9437184205290d03c22943107494b7d8a9/neo-chat/index.html?v=20260910-sharp-photos-v1",
      width: 1180,
      height: 760,
      launcher: true,
      pinned: true,
