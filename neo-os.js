(function () {
  ...
  var apps = {
    browser: {
      ...
      icon: "duckduckgo",
    route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@0373a0e92e72151435dfdde6843e37797be85ca0/NEO-BROWSER/index.html?v=20260912-proxy-ready-v2",
      keepAlive: false,
      width: 1080,
      height: 720,
      launcher: true,
    ...
    chat: {
      ...
      icon: "chat",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@923c456694a68c8634079a94659395fed5645308/neo-chat/index.html?v=20260921-no-call-buttons-v1",
      width: 1180,
      height: 760,
      launcher: true,
      pinned: true,
