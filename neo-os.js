(function () {
  ...
  var apps = {
    ...
    chat: {
      ...
      icon: "chat",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@b262469497cf6a6d551a5e3497b020478b5e4d5d/neo-chat/index.html?v=20260919-messages-sync-v1",
      width: 1180,
      height: 760,
      launcher: true,
      pinned: true,
