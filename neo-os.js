(function () {
  ...
  var apps = {
    browser: {
      ...
      icon: "duckduckgo",
    route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@7ec33897bfe3ac1273293888855984d98a097ae4/NEO-BROWSER/index.html?v=20260912-proxy-ready-v2",
      keepAlive: true,
      width: 1080,
      height: 720,
      launcher: true,
    ...
    chat: {
      ...
      icon: "chat",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@d6bd5dd017881b733ef08adf26e4ebc6dd825ce3/neo-chat/index.html?v=20260910-sharp-photos-v1",
      width: 1180,
      height: 760,
      launcher: true,
      pinned: true,
