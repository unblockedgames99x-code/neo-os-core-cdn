(function () {
  ...
  var apps = {
    browser: {
      ...
      icon: "duckduckgo",
    route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-browser-cdn@d98249212d1ffd3dfbb6611b71175283efc722c1/NEO-BROWSER/index.html?v=20260912-proxy-ready-v2",
      keepAlive: true,
      width: 1080,
      height: 720,
      launcher: true,
    ...
    chat: {
      ...
      icon: "chat",
      route: "https://fastly.jsdelivr.net/gh/unblockedgames99x-code/neo-os-chat-tv-cdn@dda4a02f0664669e9bc99124d73ca1347ef2443f/neo-chat/index.html?v=20260910-sharp-photos-v1",
      width: 1180,
      height: 760,
      launcher: true,
      pinned: true,
