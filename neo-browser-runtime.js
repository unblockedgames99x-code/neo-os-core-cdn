(() => {
  ...
  function mountBrowser(container, runtime, target, options = {}) {
    ...
    shell.innerHTML = `
      ...
      <nav class="neo-browser-toolbar" aria-label="Web controls">
        ...
        <form class="neo-browser-address" data-browser-address-form>
          <span class="neo-browser-address-mark" aria-hidden="true"><img src="${browserAsset("assets/duckduckgo.1233e0f05f2c79e7.webp")}" width="17" height="17" alt="" /></span>
    ...
    function updateTabIcon(tab) {
      if (!tab?.icon) return;
      let iconHref = browserAsset("assets/duckduckgo.1233e0f05f2c79e7.webp");
      try {
    ...
    function createTab(destination, options = {}) {
      ...
      element.innerHTML = `
        <button class="neo-browser-tab" type="button" role="tab" aria-selected="false" tabindex="-1">
          <img class="neo-browser-tab-icon" src="${browserAsset("assets/duckduckgo.1233e0f05f2c79e7.webp")}" width="16" height="16" alt="" />
