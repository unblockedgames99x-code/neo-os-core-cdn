  ...
  function mountAppInstaller(body) {
    ...
    form.addEventListener("submit", function (event) {
      ...
      try {
        ...
        setStatus(app.title + " installed.", false);
